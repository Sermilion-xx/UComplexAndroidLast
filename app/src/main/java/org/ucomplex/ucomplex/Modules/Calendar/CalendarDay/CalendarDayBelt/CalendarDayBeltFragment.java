...
public class CalendarDayBeltFragment extends BaseMvpFragment<CalendarDayBeltPresenter> {

    public static final String EXTRA_DAY = "day";

    public static CalendarDayBeltFragment getInstance(String day) {
        CalendarDayBeltFragment fragment = new CalendarDayBeltFragment();
