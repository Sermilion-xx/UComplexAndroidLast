...
public class CalendarDayEventsFragment extends BaseMvpFragment<CalendarDayEventsPresenter> {

    public static final String EXTRA_DAY = "day";

    public static CalendarDayEventsFragment getInstance(String day) {
        CalendarDayEventsFragment fragment = new CalendarDayEventsFragment();
    ...
    @Inject
    protected CalendarDayEventsAdapter mAdapter;
