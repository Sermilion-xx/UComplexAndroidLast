...
import static org.ucomplex.ucomplex.R.id.recyclerView;
...
public class CalendarStatisticsFragment extends BaseMvpFragment<CalendarStatisticsPresenter> {

    public static CalendarStatisticsFragment getInstance() {
        return new CalendarStatisticsFragment();
    }
    ...
    @Inject
    protected CalendarStatisticsAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getActivityContext(),
