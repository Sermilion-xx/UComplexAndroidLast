...
public class RoleInfoTeacherProfileFragment extends BaseMvpFragment<RoleInfoTeacherProfilePresenter> {
    ...
    private RoleInfoTeacherProfileAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RoleInfoTeacherProfileAdapter();
